<h2><a href="https://www.geeksforgeeks.org/problems/c-input-output2432/1?page=1&category=CPP&status=unsolved&sortBy=submissions">C++ Input / Output</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two&nbsp;integers A and B. Your task is to&nbsp;return their product.</span></p>
